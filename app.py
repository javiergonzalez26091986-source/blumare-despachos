...
if not datos_ventas:
    ...
    # Convertimos a DataFrame para facilitar filtros rápidos
    ...
    if busqueda:
        df = df[df['cliente'].str.contains(busqueda, case=False) | df['producto'].str.contains(busqueda, case=False)]
    ...
    for _, fila in df.iterrows():
        ...
        # HTML Estructurado para cada tarjeta de pedido
        card_html = f"""
        <div class="delivery-card">
            ...
            <div style="margin-top: 15px; border-top: 1px solid #30363d; pt-10px; font-size: 14px;">
                ...
                <p style="margin: 5px 0 5px 0; color: #8b949e;">📍 <b>Dirección:</b> {fila['direccion']}</p>
            </div>
            <div style="display: flex; justify-content: space-between; margin-top: 15px; font-size: 11px; color: #58a6ff;">
                <span>👤 Repartidor: {fila['repartidor']}</span>
